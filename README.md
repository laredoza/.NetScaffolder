...
T4 templates (DataTypes) are used to generate a layer. Packages group several of these templates. A domain will be set to use a package to generate the required layers.
