namespace RepositoryEFDotnet.UnitTest
{
    ...
    [TestClass]
    public class UowNHibernateInMemoryOracleUnitTest : BaseUnitOfWorkUnitTests
    {
        #region Constants
        ...
        private static OracleFullContext Context = null;
        ...
        public static void TestInit(TestContext tstContext)
        {
            ...
            Context = new OracleFullContext(Configuration);
