...
{
    [DbContext(typeof(PostgresFullContext))]
    partial class PostgresFullContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("DotNetScaffolder.Domain.Data.Entities.DefaultEntity.Entity.BankTransfers", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FromBankAccountId = 1,
                            ToBankAccountId = 2,
                            TransferDate = new DateTime(2019, 1, 2, 10, 23, 4, 674, DateTimeKind.Local).AddTicks(7058)
                        });
                });
            ...
            modelBuilder.Entity("DotNetScaffolder.Domain.Data.Entities.DefaultEntity.Entity.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            CustomerId = 2,
                            DeliveryDate = new DateTime(2019, 1, 2, 10, 23, 4, 677, DateTimeKind.Local).AddTicks(1185),
                            OrderDate = new DateTime(2019, 1, 2, 10, 23, 4, 677, DateTimeKind.Local).AddTicks(171),
