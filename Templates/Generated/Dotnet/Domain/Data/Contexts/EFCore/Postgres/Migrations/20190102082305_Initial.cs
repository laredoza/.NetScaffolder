...
namespace DotNetScaffolder.Domain.Data.Contexts.EFCore.Postgres.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 10000m, "001", 1, false },
                    { 2, 20000m, "002", 2, false }
                });

            migrationBuilder.InsertData(
                table: "Order",
                columns: new[] { "OrderId", "CustomerId", "DeliveryDate", "OrderDate", "ShippingAddress", "ShippingCity", "ShippingName", "ShippingZip" },
                values: new object[] { 1, 2, new DateTime(2019, 1, 2, 10, 23, 4, 677, DateTimeKind.Local).AddTicks(1185), new DateTime(2019, 1, 2, 10, 23, 4, 677, DateTimeKind.Local).AddTicks(171), "2nd road", "London", "Mary", "123" });

            migrationBuilder.InsertData(
                table: "BankTransfers",
                columns: new[] { "BankTransferId", "Amount", "FromBankAccountId", "ToBankAccountId", "TransferDate" },
                values: new object[] { 1, 100m, 1, 2, new DateTime(2019, 1, 2, 10, 23, 4, 674, DateTimeKind.Local).AddTicks(7058) });
