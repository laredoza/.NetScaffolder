    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_`Country`", x => x.CountryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_`Product`", x => x.ProductId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_`Customer`", x => x.CustomerId);
                    table.ForeignKey(
                        name: "FK_`Customer`_`Country`_CountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_`Book`", x => x.ProductId);
                    table.ForeignKey(
                        name: "FK_`Book`_`Product`_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_`Software`", x => x.ProductId);
                    table.ForeignKey(
                        name: "FK_`Software`_`Product`_ProductId",
                        column: x => x.ProductId,
                        principalTable: "`Product`",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_`BankAccount`", x => x.BankAccountId);
                    table.ForeignKey(
                        name: "FK_`BankAccount`_`Customer`_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_`Order`", x => x.OrderId);
                    table.ForeignKey(
                        name: "FK_`Order`_`Customer`_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "`Customer`",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_`BankTransfers`", x => x.BankTransferId);
                    table.ForeignKey(
                        name: "FK_`BankTransfers`_`BankAccount`_ToBankAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_`OrderDetails`", x => x.OrderDetailsId);
                    table.ForeignKey(
                        name: "FK_`OrderDetails`_`Order`_OrderId",
                        column: x => x.OrderId,
                        principalTable: "`Order`",
                        principalColumn: "OrderId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_`OrderDetails`_`Product`_ProductId",
                        column: x => x.ProductId,
                        principalTable: "`Product`",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 2, new DateTime(2019, 1, 1, 18, 27, 39, 849, DateTimeKind.Local).AddTicks(4670), new DateTime(2019, 1, 1, 18, 27, 39, 849, DateTimeKind.Local).AddTicks(3652), "2nd road", "London", "Mary", "123" });

            migrationBuilder.InsertData(
                table: "`BankTransfers`",
                columns: new[] { "BankTransferId", "Amount", "FromBankAccountId", "ToBankAccountId", "TransferDate" },
                values: new object[] { 1, 100m, 1, 2, new DateTime(2019, 1, 1, 18, 27, 39, 847, DateTimeKind.Local).AddTicks(794) });
