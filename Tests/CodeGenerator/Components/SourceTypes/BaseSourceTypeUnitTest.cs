...
namespace DotNetScaffolder.Test.Components.SourceTypes
{
    ...
    public class BaseSourceTypeUnitTest
    {
        ...
        public void BaseSourceTypeUnitTest_TestValues(DatabaseModel databaseModel)
        {
            ...
            BaseSourceTypeUnitTest_TestProductTable(
                databaseModel.Tables.FirstOrDefault(t => t.TableName == "Product"));
            BaseSourceTypeUnitTest_TestProductRelationships(databaseModel.Tables.FirstOrDefault(t => t.TableName == "Product"));
            BaseSourceTypeUnitTest_TestBook(databaseModel.Tables.FirstOrDefault(t => t.TableName == "Book"));
            BaseSourceTypeUnitTest_TestBookRelationships(databaseModel.Tables.FirstOrDefault(t => t.TableName == "Book"));

            BaseSourceTypeUnitTest_TestOrderDetailsTable(databaseModel.Tables.FirstOrDefault(t => t.TableName == "OrderDetails"));
            BaseSourceTypeUnitTest_OrderDetailsBook(databaseModel.Tables.FirstOrDefault(t => t.TableName == "OrderDetails"));

            BaseSourceTypeUnitTest_SoftwareTable(databaseModel.Tables.FirstOrDefault(t => t.TableName == "Software"));
            BaseSourceTypeUnitTest_Software(databaseModel.Tables.FirstOrDefault(t => t.TableName == "Software"));

            BaseSourceTypeUnitTest_CustomerTable(databaseModel.Tables.FirstOrDefault(t => t.TableName == "Customer"));
            BaseSourceTypeUnitTest_CustomerRelationship(databaseModel.Tables.FirstOrDefault(t => t.TableName == "Customer"));

            BaseSourceTypeUnitTest_OrderTable(databaseModel.Tables.FirstOrDefault(t => t.TableName == "Order"));
            BaseSourceTypeUnitTest_OrderRelationship(databaseModel.Tables.FirstOrDefault(t => t.TableName == "Order"));

            BaseSourceTypeUnitTest_CountryTable(databaseModel.Tables.FirstOrDefault(t => t.TableName == "Country"));
            BaseSourceTypeUnitTest_CountryRelationship(databaseModel.Tables.FirstOrDefault(t => t.TableName == "Country"));

            BaseSourceTypeUnitTest_BankAccountTable(databaseModel.Tables.FirstOrDefault(t => t.TableName == "BankAccount"));
            BaseSourceTypeUnitTest_BankAccountRelationship(databaseModel.Tables.FirstOrDefault(t => t.TableName == "BankAccount"));

            BaseSourceTypeUnitTest_BankTransfersTable(databaseModel.Tables.FirstOrDefault(t => t.TableName == "BankTransfers"));
            BaseSourceTypeUnitTest_BankTransfersRelationship(databaseModel.Tables.FirstOrDefault(t => t.TableName == "BankTransfers"));
        }
